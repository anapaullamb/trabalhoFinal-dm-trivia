...
class EmailAuthServiceImpl implements IAuthService {
  ...
  Future<Either<Failure, UserCredentialApp>> signIn(
    ...
    try {
      ...
      var dataResponde = await FirebaseFirestore.instance
          ...
          .get();
      print("teste1231");
      print(dataResponde.data().toString());
      print(dataResponde.data());
      UserCredentialApp userReponse = UserCredentialApp(
        ...
        categorias: dataResponde.data()?['categorias'],
        pontuacao: dataResponde.data()?['pontuacao'] as int,
      );
  ...
  @override
  Future<int> incrementaPontuacao(String userId, int pontuacao)  async{
    int pontos = pontuacao + 1;
    var docUser = await FirebaseFirestore.instance.collection('Users').doc(userId);
    docUser.update({'pontuacao':pontos});
